...
// Hero headline entrance: one controlled SplitText reveal, word by word (Home page only)
...
// Services data (Home + services.html)
const services = [
...
// Work bento data (Home + work.html): real projects only.
const projects = [
